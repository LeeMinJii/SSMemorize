...
public class DBHelper_MID extends SQLiteOpenHelper {
    public static int DATABASE_VERSION = 1;
    private static String TAG = "DBHelper";

    private static String databasePath = "/data/data/com.example.ssmemorize/databases/"; // 데이터베이스 경로
    private static String databaseName = "middle_Word.db"; // 데이터베이스 이름
    private static String tableName = "middle_Word"; // 테이블 이름

    public static SQLiteDatabase mDataBase;
    private final Context mContext;

    public DBHelper_MID(Context context) {
