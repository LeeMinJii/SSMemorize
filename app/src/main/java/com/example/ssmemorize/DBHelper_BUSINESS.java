...
public class DBHelper_BUSINESS extends SQLiteOpenHelper {
    public static int DATABASE_VERSION = 1;
    private static String TAG = "DBHelper";

    private static String databasePath = "/data/data/com.example.ssmemorize/databases/"; // 데이터베이스 경로
    private static String databaseName = "business_Word.db"; // 데이터베이스 이름
    private static String tableName = "business_Word"; // 테이블 이름

    public static SQLiteDatabase mDataBase;
    private final Context mContext;

    public DBHelper_BUSINESS(Context context) {
